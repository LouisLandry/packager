 ...
 *
 * Additional functionality added assuming a namespace of
 * joomla/joomla/p12_4 for all Joomla Platform classes
 *
...
if (!class_exists(__NAMESPACE__.'\JPlatform'))
{
	require_once JPATH_PLATFORM . '/platform.php';
}

// Import the library loader if necessary.
if (!class_exists(__NAMESPACE__.'\JLoader'))
{
...
JLoader::registerPrefix('joomla\\joomla\\p12_4\\J', JPATH_PLATFORM . '/joomla');
